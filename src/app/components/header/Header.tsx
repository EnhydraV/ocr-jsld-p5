...
// Header de la zone connectée. `-mx-4 px-4` étend la ligne de séparation
// jusqu'aux bords du conteneur (qui porte un gutter `px-4`). Le panneau mobile
// est géré en `fixed` par HeaderNav, pas besoin d'ancrage ici.
